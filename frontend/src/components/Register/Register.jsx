	...
	return (
		<section className="info-tooltip">
			<form className="info-tooltip__form" onSubmit={handeSubmit}>
				<p className="info-tooltip__title">Регистрация</p>
				...
				<button className="info-tooltip__button-submit" type="submit">{isLoading ? "Выполняется регистрация" : "Зарегистрироваться"}</button>
				<Link to="/sign-in" className="info-tooltip__button-authorization" type="button">Уже зарегистрированы? Войти</Link>
			</form>
		</section>
	)
}